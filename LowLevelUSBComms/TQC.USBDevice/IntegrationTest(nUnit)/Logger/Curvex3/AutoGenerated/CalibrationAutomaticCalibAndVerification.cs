...
using TQC.USBDevice;
namespace TQC.USBDevice.AutoGenerated.TQCCurveX3Standard.CalibrationAutomaticCalibAndVerification
{
    [TestFixture]
        ...
        public void PayloadMicrovolts()
        {
            using (var logger = new TQCUsbLogger(null))
            {
                if (logger.OpenWithMinumumRequests(ProductId))
                {
                    ...
                    Console.WriteLine("Voltage 7 = {0}",  BitConverter.ToInt16(result, 14));
                    Console.WriteLine("Voltage 8 = {0}",  BitConverter.ToInt16(result, 16));
        ...
        public void CalibrationDetails5()
        {
            using (var logger = new TQCUsbLogger(null))
            {
                if (logger.OpenWithMinumumRequests(ProductId))
                {
                    ...
                    var result = logger.GetResponse(0, (USBLogger.Commands)0x12, 0x18, request);
        ...
        public void CalibrationDetails6()
        {
            using (var logger = new TQCUsbLogger(null))
            {
                if (logger.OpenWithMinumumRequests(ProductId))
                {
                    ...
                    var result = logger.GetResponse(0, (USBLogger.Commands)0x12, 0x19, request);
